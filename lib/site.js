...
import { QUERY_SITE_DATA, QUERY_SEO_DATA } from 'graphql/queries/site';
...
export async function getSiteMetadata() {
  ...
  try {
    ...
    console.warn(`[site][getSiteMetadata] Failed to query site data: ${e.message}`);
    throw e;
  }
  ...
  if (process.env.WORDPRESS_PLUGIN_SEO === true) {
    try {
      ...
      console.warn(`[site][getSiteMetadata] Failed to query SEO plugin: ${e.message}`);
