...
import { QUERY_ALL_USERS, QUERY_ALL_USERS_PATH, QUERY_ALL_USERS_SEO, QUERY_ALL_USERS_SLUG, QUERY_USER_BY_SLUG } from 'graphql/queries/users';
 ...
 */
 ...
 export async function getAllUsers() {
  ...
  try {
    ...
    console.warn(`[users][getAllUsers] Failed to query users data: ${e.message}`);
    throw e;
  }
  ...
  if (process.env.WORDPRESS_PLUGIN_SEO === true) {
    try {
      ...
      console.warn(`[users][getAllUsers] Failed to query SEO plugin: ${e.message}`);
